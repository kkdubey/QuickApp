    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        private async Task SeedDefaultUsersAsync()
        {
            if (!await _context.Users.AnyAsync())
            {
                ...
                await CreateUserAsync("admin", "tempP@ss123", "Inbuilt Administrator", "admin@testapp.com", "+1 (123) 000-0000", new string[] { adminRoleName });
                await CreateUserAsync("user", "tempP@ss123", "Inbuilt Standard User", "user@testapp.com", "+1 (123) 000-0001", new string[] { userRoleName });
        ...
        private async Task SeedDemoDataAsync()
        {
            if (!await _context.Customers.AnyAsync() && !await _context.ProductCategories.AnyAsync())
            {
                ...
                {
                    Name = "Komal Dube",
                    Email = "kkdubey1989@gmail.com.com",
                    Gender = Gender.Male,
